...
public class SpotifySerializer {
    ...
    public static void serializer() throws IOException, CsvValidationException {
        // Paths
        String CSV_FILE_PATH = "tracks-small.csv"; //CAMBIAR DESTINO SI ES NECESARIO
